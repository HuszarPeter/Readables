...
namespace MobiMetadataReader.Net.Metadata
{
    public class MobiHead : BaseHeader
    {
        ...
        byte[] mobiType = new byte[4];
        byte[] textEncoding = new byte[4];
        byte[] uniqueID = new byte[4];
        byte[] fileVersion = new byte[4];
        byte[] orthographicIndex = new byte[4];
        byte[] inflectionIndex = new byte[4];
        byte[] indexNames = new byte[4];
        byte[] indexKeys = new byte[4];
        byte[] extraIndex0 = new byte[4];
        byte[] extraIndex1 = new byte[4];
        byte[] extraIndex2 = new byte[4];
        byte[] extraIndex3 = new byte[4];
        byte[] extraIndex4 = new byte[4];
        byte[] extraIndex5 = new byte[4];
        byte[] firstNonBookIndex = new byte[4];
        byte[] fullNameOffset = new byte[4];
        byte[] fullNameLength = new byte[4];
        byte[] locale = new byte[4];
        byte[] inputLanguage = new byte[4];
        byte[] outputLanguage = new byte[4];
        byte[] minVersion = new byte[4];
        byte[] firstImageIndex = new byte[4];
        byte[] huffmanRecordOffset = new byte[4];
        byte[] huffmanRecordCount = new byte[4];
        byte[] huffmanTableOffset = new byte[4];
        byte[] huffmanTableLength = new byte[4];
        byte[] exthFlags = new byte[4];
        byte[] restOfMobiHeader;
        readonly EXTHHead exthHeader;

...
namespace MobiMetadataReader.Net.Metadata
{
    public class PDBHead : BaseHeader
    {
        ...
        byte[] creationDate = new byte[4];
        byte[] modificationDate = new byte[4];
        byte[] lastBackupDate = new byte[4];
        byte[] modificationNumber = new byte[4];
        byte[] appInfoID = new byte[4];
        byte[] sortInfoID = new byte[4];
        byte[] type = new byte[4];
        byte[] creator = new byte[4];
        byte[] uniqueIDSeed = new byte[4];
        byte[] nextRecordListID = new byte[4];
        byte[] numRecords = new byte[2];
        List<RecordInfo> recordInfoList = new List<RecordInfo>();
        byte[] gapToData = new byte[2];
        ...
        {
            readonly byte[] recordDataOffset = new byte[4];
            byte recordAttributes;
